      ...
      <div className="max-w-3xl mx-auto text-center">
        ...
        <div className="flex justify-center gap-4">
          ...
          <a
            ...
            className="flex items-center gap-2 px-6 py-3 bg-surface-container hover:bg-surface-container-high rounded-xl text-on-surface-variant hover:text-on-surface transition-all group"
          >
          ...
          {/* Instagram */}
          <a
            href="https://instagram.com/lumicatech"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 px-6 py-3 bg-surface-container hover:bg-surface-container-high rounded-xl text-on-surface-variant hover:text-on-surface transition-all group"
          >

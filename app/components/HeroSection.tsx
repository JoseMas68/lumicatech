      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 w-full relative z-10 flex flex-col items-center text-center">
        ...
        >
          ...
          >
            ...
            <span className="font-mono text-xs uppercase tracking-[0.2em] text-primary font-bold">Estándar de calidad 2026</span>
          </motion.div>
          ...
          >
            ...
            <span className="text-gradient-primary font-bold italic pr-2">soluciona</span> problemas
          </motion.h1>
          ...
          >
            <Link 
              href="/booking"
              className="w-full sm:w-auto group relative inline-flex items-center justify-center gap-2 overflow-hidden rounded-xl bg-gradient-to-br from-primary to-primary-container text-white px-8 py-4 font-bold tracking-tight transition-all hover:scale-[1.02] active:scale-95 shadow-[0_0_20px_rgba(0,196,217,0.3)]"
            >
            ...
            <Link 
              href="#projects"
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl font-bold tracking-tight text-primary border border-primary/30 hover:bg-primary/5 transition-all active:scale-95"
            >
              Ver ecosistema
            </Link>
          </motion.div>

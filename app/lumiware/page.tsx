...
export default function LumiwarePage() {
  return (
    <div className="min-h-screen flex flex-col bg-[#050505] text-white selection:bg-primary-container/30 selection:text-primary-container overflow-x-hidden font-sans">
      <Header />
